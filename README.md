...
- 1週間ゲームジャム作品のとりまとめ(公開できていたら一通り揃っているはずなので不要)
  ...
  - 使用アセットリスト
- チーム制作用の企画提案書
  - 本講義や企画の講義で教わったことを活用して、以下についてGoogleドキュメントやスライドにまとめる
  - 使用予定の制作環境(Unity, GDevelop, Cluster, ティラノスクリプト, その他)
  - 画面レイアウトのサムネイルを最低１枚用意する。形式は手書きしたものをスマホで撮影して取り込んだものでも、Unityなどで作成したものでも自由。分かれば良い)
  - 取りまとめに記載したことは最低限書き、それ以外にも各種YouTube動画などを参考に盛り付ける
- 締め切りと発表
  - 1/11(水)に発表
